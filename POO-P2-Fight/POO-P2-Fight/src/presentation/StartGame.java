...
public class StartGame {
	...
	/*WARNING: DO NOT MODIFY THIS CODE IN ANY WAY. THE ONLY MODIFICATION YOU CAN MAKE IS CHANGING new Game FOR new SurvivorGame*/
	...
	/**
	 * Rep la consola com a paràmetre d’entrada i retorna l’opció de menú seleccionada per l’usuari. 
	 * El procediment s’encarrega de mostrar un menú a l’usuari per seleccionar un personatge (guerrer, mag, o arquer). 
	 * Si l’opció seleccionada no està entre les donades, el procediment insisteix fins que l’usuari introdueix l’opció correcta.
	 * @param console
	 * @return
	 */
