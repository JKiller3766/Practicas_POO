...
public class ShipType {
	...
	public static void createShipTypes() {
		...
		for(int i = 0; i<id.length;i++) {
			switch(i) {
			case 0: size[i] = 2; id[i] = "DE"; name[i] = "DESTROYER";
			break;
			case 1: size[i] = 3; id[i] = "SU"; name[i] = "SUBMARINE";
			break;
			case 2: size[i] = 3; id[i] = "CR"; name[i] = "CRUISER";
			break;
			case 3: size[i] = 4; id[i] = "BA"; name[i] = "BATTLESHIP";
			break;
			default: size[i] = 5; id[i] = "CA"; name[i] = "CARRIER";
			}
